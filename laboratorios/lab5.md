...
## Códigos de ayuda
* [[Gurobi 3: Carga de datos Parte 1]](laboratorios\files\Gurobi3_Datos_Actualizado.ipynb)
* [[Gurobi 3: Carga de datos Parte 2]](laboratorios\files\Gurobi3_CargaDatos_Parte2.ipynb)
...
* Código Python en .py.
* Archivo CSV/Excel utilizado.
* Capturas de pantalla de los resultados.
* Breve reporte explicando el impacto de los datos en la optimización.
