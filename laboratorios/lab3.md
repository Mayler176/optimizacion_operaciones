...
## Códigos de ayuda
* [[Introducción  a Colab]](files/0_Introduccion_Colab_Python.ipynb)
* [[Gurobi 1: Introducción]](laboratorios\files\Gurobi1_Introduccion.ipynb)
...
* Resolver el modelo con Gurobi y obtener la solución óptima.
* Analizar la solución e interpretar los resultados, asegurando que:
    * Se identifiquen los valores óptimos de las variables de decisión.
...
* Captura de pantalla de la solución óptima y salida del modelo.
* Breve reporte explicando los elementos del modelo y la interpretación de la solución.
