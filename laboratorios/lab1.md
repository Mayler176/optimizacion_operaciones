...
* Para cada restricción, define la celda que corresponde a la expresión matemática de la restricción (por ejemplo, las celdas para las ecuaciones a11 * x1 + a12 * x2), el operador de comparación (≤, =, o ≥) y el valor de la restricción (por ejemplo, 32 y 36).
...
* Asegúrate de que las variables x1 y x2 sean mayores o iguales a cero (esto lo puedes agregar como restricción x1, x2 ≥ 0).
...
* Si $x1 = 10$ y $x2 = 3$ es la solución óptima, podrás calcular el valor de la función objetivo $Z = 30 * 10 + 40 * 3 = 420$, que es el valor máximo que se puede lograr bajo las restricciones dadas.
...
**Formato de entrega**
* Nombre del entregable: *Lab1_A000000*
